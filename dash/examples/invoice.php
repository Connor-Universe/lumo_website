          ...
          <div class="container" id="invoice">
              <div class="row">
                  ...
                  <div class="card card-nav-tabs text-center">
                     ...
                     <h3>Company <?php echo"$coin";?> address: <input id="input" type = "text" class="form-control" value="<?php echo"$wallet";?>" disabled><button class="btn btn-primary" id="clipboardCopy">Copy</button></h3>
