...
if (!$mail->send()) {
    ...
    $insert_bonus = "INSERT INTO bonus (id_no,amount,reference_id,date) VALUES('$id_no','$amount','$reference_id','$date12')";
...
$run_insert_total = mysqli_query($connect,$insert_total);
    header("location:../examples/add_bonus.php?success=true#$id_no");
}
