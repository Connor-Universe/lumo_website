...
<div class="wrapper">
    ...
    $get_refer = "select * from users where referal_code = '$promo_code'";
    $run_refer = mysqli_query($connect,$get_refer);
    $row_refer = mysqli_fetch_array($run_refer);
    $first_refer = $row_refer['first_name'];
    $last_refer = $row_refer['last_name'];
    $user_name = $row_refer['username'];

    echo"
    <tr>
    <td>$first_name $last_name <br> $username</td>
    <td>$first_refer $last_refer <br> $user_name</td>
</tr>
    ";
  }
    ?>
